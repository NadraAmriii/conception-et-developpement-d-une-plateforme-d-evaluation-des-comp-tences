<?php
session_start();
if( !isset($_SESSION['username']) ) // Accès non authentifié !
{
...
include("manage_users_class.php");
$users=new manage_users_class;			// creating object of  manage_courses_class.php
$user=$users->display_courses();    //calling display_courses() method from manage_courses_class.php
...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../admin_main.php">Testiny</a>
...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            <li class="list-group-item  bg-dark "><a href="">Admin space </a></li>
            <li class="list-group-item bg-dark "><a href="#">Manage Compagnies</a></li>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage_course">Manage user</a>
  </li>
 <!--  <li class="nav-item">
...
<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>THE USERS </b></div><br>
<div class="row">
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
            ...
            <div class="card-body col-md-12">
				  ...
				  <form action="user_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
					    <div class="form-group">
					      <label for="email">user Name :</label>
					      <input type="text" class="form-control" id="u_name" placeholder="Enter user Name" name="user_name">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
					    <div class="form-group">
					      <label for="pwd">user email</label>
					      <input type="text" class="form-control" id="u_email" placeholder="Enter email" name="user_email">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>
						<div class="form-group">
					      <label for="pwd">user password</label>
					      <input type="text" class="form-control" id="u_pass" placeholder="Enter password" name="user_pass">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>

					    <div class="form-group">
					      <label for="role">user Role :</label>
					      <input type="text" class="form-control" id="u_role" placeholder="Enter user pseudo" name="user_role">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
          ...
          <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2 "><h3>UPDATE USER</h3></div>
				  
				  <div class="card-body small" >
					    
				 

				 <form action="user_add.php" method="post" enctype="multipart/form-data" onsubmit="">


				 	 <div class="form-group">

					    <label for="exampleFormControlSelect1">Select User Name :</label>
					    <select class="form-control" id="exampleFormControlSelect1" name="selected-course-to-update">

					    	<?php  foreach ($user as $users_list)
							 {
										?> 
					      <option><?php echo  $users_list['namee']; ?></option>
					      <?php } ?>
						...
						<div class="form-group">
					      ...
					      <input type="text" class="form-control" id="u_pass" placeholder="Enter pass" name="user_pass">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>
						<div class="form-group">
					      <label for="role">role</label>
					      <input type="text" class="form-control" id="u_role" placeholder="Enter pass" name="user_role">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>
          ...
          <div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2"><h3>DELETE USER</h3></div>
...
// =============================================================================================================
	...
	function validation()
	{
		...
		if (email=="")
		{ 
			document.getElementById('email_error').innerHTML="** please enter the user email";
			return false;

		}
		if (password=="")
		{ 
			document.getElementById('pass_error').innerHTML="** please enter the user password";
			return false;

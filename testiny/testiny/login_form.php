<form id="login_form1" class="form-signin" method="post">
			...
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as Teacher" id="signin_teacher" onclick="window.location='signup_entreprise.php'" name="login" class="btn btn-info" type="submit">Entreprise</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){

<?php
    ...
    if ( !empty($_POST)){
        ...
        if ($valid){
            ...
            $sql = "INSERT INTO utilisateurs (pseudo, email, password) values(?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($pseudo, $email, $password));
            Database::disconnect();
...
<div class="container">
    ...
    <form class="form-horizontal" action="create.php" method="post">
        ...
        <div class="form-group <?php echo !empty($passwordError)?'error':'';?>">
            ...
            <div class="form-group">
                <input class="form-control" name="password" type="text"  placeholder=" paswword" value="<?php echo !empty($password)?$password:'';?>" style="width: 500px">
        ...
        <div class="form-actions">
            ...
            <a class="btn btn-dark" href="add.php">Back</a>
        </div>
    </form>
</div> <!-- /container -->
